...
- Flow: Video upload -> Crop -> Extract to 20~40 frames at once --> edit = crop/trim both -> frames auto extracted at once

- Upload to google drive, progress bar ==> n8n & slack, cross check with google sheets DB (if Cx ordered)

- Flipping speed config; 1second for 10 frames for now, adjustment required
